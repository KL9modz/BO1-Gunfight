...
//   Lethal    : 18 Frag / 18 Semtex / 18 Tomahawk   (Semtex = sticky_grenade_mp;
//               satchel_charge_mp is C4 and lives ONLY in the equipment slot)
//   Equipment : 14 Camera / 13 Jammer / 13 Motion / 7 Claymore / 7 C4
//   Secondary : pistols 6 each (Python/Makarov/M1911/CZ75) + even mix of
...
gf_initLoadouts()
{
    ...
    pool[n] = gf_buildLoadout(
        ...
        gf_item( "sticky_grenade_mp",          "Semtex",         "hud_icon_sticky_grenade" ),
    ...
    pool[n] = gf_buildLoadout(
        gf_item( "m202_flash_wager_mp",        "M202 FLASH",     "hud_m202" ),
        gf_item( "python_mp",                  "Python",         "menu_mp_weapons_python" ),
        gf_item( "hatchet_mp",                 "Tomahawk",       "hud_hatchet" ),
        gf_item( "concussion_grenade_mp",      "Stun",           "hud_us_stungrenade" ),
