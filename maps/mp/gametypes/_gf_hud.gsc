...
gf_showScorePopup( popupType, pri )
{
    ...
    self.hud_rankscroreupdate.baseFontScale = gf_popupSize();
    self.hud_rankscroreupdate.maxFontScale  = gf_popupSize() * 2;
    self.hud_rankscroreupdate.fontScale     = gf_popupSize();
    self.hud_rankscroreupdate.x             = gf_popupX();
    self.hud_rankscroreupdate.y             = gf_popupY();
