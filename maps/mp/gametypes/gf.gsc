...
onStartGameType()
{
    ...
    if ( getDvar( "scr_gf_min_players" ) == "" )
        setDvar( "scr_gf_min_players", "1" );
    if ( getDvar( "scr_gf_load_wait" ) == "" )
        setDvar( "scr_gf_load_wait", "0" );
    if ( getDvar( "scr_gf_load_grace" ) == "" )
        setDvar( "scr_gf_load_grace", "20" );
    if ( getDvar( "scr_gf_lobby" ) == "" )
        setDvar( "scr_gf_lobby", "0" );
    if ( getDvar( "scr_gf_lobby_timer" ) == "" )
        setDvar( "scr_gf_lobby_timer", "600" );
    if ( getDvar( "gf_fill_n" ) == "" )
        setDvar( "gf_fill_n", "0" );
    if ( getDvar( "gf_fill_kick_floor" ) == "" )
        setDvar( "gf_fill_kick_floor", "2" );
