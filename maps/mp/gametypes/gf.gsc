...
main()
{
    ...
    maps\mp\gametypes\_globallogic_utils::registerTimeLimitDvar(     level.gameType, 0.7, 0, 1440 );
...
onPrecacheGameType()
{
    ...
    precacheShader( "perk_marathon_pro_256" );
    ...
    precacheString( &"GF_POPUP_CAPTURE" );
...
gf_roundSeedDvars()
{
    ...
    gf_seedDvar( "scr_team_maxsize", "0" );
    ...
    gf_seedDvar( "scr_gf_lethals", "1" );
    gf_seedDvar( "scr_gf_tacticals", "1" );
    gf_seedDvar( "scr_gf_equipment", "1" );

    gf_seedDvar( "scr_gf_camo_base", "1" );
    gf_seedDvar( "scr_gf_camo_modded", "1" );
    gf_seedDvar( "scr_gf_camo_trim", "stock" );
...
gf_roundWorldSetup()
{
    ...
    maps\mp\gametypes\_rank::registerScoreInfo( "loss",     2.5  );
    maps\mp\gametypes\_rank::registerScoreInfo( "tie",      3.75 );
    ...
    maps\mp\gametypes\_rank::registerScoreInfo( "assist_25", 200 );
    maps\mp\gametypes\_rank::registerScoreInfo( "assist_50", 300 );
    maps\mp\gametypes\_rank::registerScoreInfo( "assist_75", 400 );
