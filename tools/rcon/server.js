...
// ─── Status parsing ───────────────────────────────────────────────────────────
// Single-sourced in tools/status_parse.js (also required by tools/notify/join-notify.js;
// tools/status_parse.ps1 is its PowerShell twin for the two box services' panel-down
// fallback — their happy path consumes THIS process's parsed /api/tick + /api/status).
// The doctrine — END-ANCHORED columns, the three-state POSITIVE bot claim, the signed
// 16-bit port — lives in that module's header. Re-exported at the bottom of this file so
// test/server.test.js pins the panel to the shared copy.
