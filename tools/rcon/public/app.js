...
const BASE_PERKS=['specialty_movefaster','specialty_fallheight','specialty_longersprint','specialty_unlimitedsprint','specialty_armorvest','specialty_flakjacket','specialty_shades','specialty_stunprotection','specialty_bulletflinch','specialty_loudenemies'];
...
const SRV_SECTIONS = [
  ...
  { title: 'PERKS — give / remove for all players', via: 'both', vars: [
    ...
    { n:'specialty_bulletflinch',      lbl:'Hardened Pro (less flinch)', type:'perk', def:'1', tip:'specialty_bulletflinch\nReduced reaction and recoil when shot. BASE perk — granted WITHOUT Hardened itself (a Pro is just extra tokens in the perk group, so either half is grantable alone).' },
    ...
    { n:'specialty_fastmeleerecovery', lbl:'Steady Aim Pro (melee recovery)', type:'perk', def:'0', tip:'specialty_fastmeleerecovery\nFaster recovery after a knife lunge. The other half of Steady Aim Pro.' },
